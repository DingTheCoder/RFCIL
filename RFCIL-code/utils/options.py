...
def args_parser():
    ...
    #new
    parser.add_argument('--tradeoff', type=int, default = 55,help=" tradeoff between learning and forgetting ")            #330 is sweetpoint
    parser.add_argument('--num_pretrain', type=int, default= 0, help=" Number of pre-training tasks")

    # federated learning arguments
    parser.add_argument('--method', type=str, default='fedavg', help="aggregation method")
    parser.add_argument('--global_ep', type=int, default=25, help="total number of communication rounds")
    ...
    parser.add_argument('--num_data', type=int, default= 10, help="number of data per client for label skew")   # hahahahahahahahahahahahaha
    ...
    parser.add_argument('--sampling_classes', type=int, default=2, help="number of classes for sampling")  # lalalallalalalalala
